...
Write-Host "  .\scripting\asus-wifi-monitor.ps1 -ShowCommands      # Show available router commands"
Write-Host "  .\scripting\asus-wifi-monitor.ps1 -TestConnection    # Test router connectivity"
Write-Host "  .\scripting\asus-wifi-monitor.ps1                    # Gather WiFi client info"
Write-Host "  .\scripting\asus-wifi-monitor.ps1 -RouterIP 192.168.1.1 -Username admin"
